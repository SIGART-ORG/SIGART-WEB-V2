                                            ...
                                            <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                                                <tr>
                                                    <td style="text-align:left; color: #6f6f6f;">
                                                        <br>
                                                        Hola {{ $name }},<br><br>
                                                        Gracias por tu confianza, ya puede utilizar nuestros servicios.<br>
                                                        Para poder ingresar a su cuenta debe de dar clic en el siguiente link:<br><br>
                                                        <a href="{{ $urlConfirmation }}">{{ $urlConfirmation }}</a> <br><br>
