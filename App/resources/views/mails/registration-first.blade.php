                                            ...
                                            <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                                                <tr>
                                                    <td style="text-align:left; color: #6f6f6f;">
                                                        <br>
                                                        Hola {{ $name }},<br><br>
                                                        Gracias por tu confianza, sus datos se registraron correctamente.<br>
                                                        Para poder ingresar a su cuenta, primero debe de validarlo, para eso
                                                        debe de dar clic en el siguiente link <a href="{{ $urlConfirmation }}">{{ $urlConfirmation }}</a>. <br><br>
                                                ...
                                                <td style="text-align:center; margin:0 auto;">
                                                    ...
                                                    <div><!--[if mso]>
                                                        ...
                                                        <a href="{{ $urlConfirmation }}"
                                                           style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:220px;-webkit-text-size-adjust:none;">Validar cuenta</a>
                                                        <!--[if mso]>
                                                        </center>
                                                        </v:rect>
                                                        <![endif]--></div>
