                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="font-size:24px; text-align:center; padding: 0 75px; color:#6f6f6f;" class="w320 mobile-spacing; ">
                                                    Su cuenta a sido creada correctamente
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                                                <tr>
                                                    <td style="text-align:left; color: #6f6f6f;">
                                                        <br>
                                                        Hola {{ $name }},<br><br>
                                                        Gracias por tu confianza, su cuenta fue creada exitosamente<br>
                                                        Para poder iniciar sesión confirme su cuenta en el siguiente link <a href="{{ $urlConfirmation }}">{{ $urlConfirmation }}</a>. <br><br>
                                                        ¡Gracias por ser cliente!<br>
                                                        D' PINTART<br>
                                                </tr>
                                            </table>
                                        </center>
                                        <table style="margin:0 auto;" cellspacing="0" cellpadding="10" width="100%">
                                            <tr>
                                                <td style="text-align:center; margin:0 auto;">
                                                    <br>
                                                    <div><!--[if mso]>
                                                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $urlConfirmation }}" style="height:45px;v-text-anchor:middle;width:220px;" stroke="f" fillcolor="#f5774e">
                                                            <w:anchorlock/>
                                                            <center>
                                                        <![endif]-->
                                                        <a href="{{ $urlConfirmation }}"
                                                           style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:220px;-webkit-text-size-adjust:none;">Iniciar Sesión</a>
                                                        <!--[if mso]>
                                                        </center>
                                                        </v:rect>
                                                        <![endif]--></div>
                                        ...
                                        <table cellspacing="0" cellpadding="0" bgcolor="#363636"  class="force-full-width">
                                            <tr>
                                                <td style="background-color:#363636; text-align:center;">
                                                    <br>
                                                    <br>
{{--                                                    <img width="62" height="56" src="https://www.filepicker.io/api/file/FjkhDKXsTFyaHnXhhBCw">--}}
